...
/>
 ...
 <Aboutusnav/>
 <CommonNavbar/>
 <MainImage MainHead={"Register"} SubHead={"Register"}/>
<RegisterForm/>
 <Footer/>
...
function RegisterForm() {
  return (
    <div className="flex flex-col sm:flex-row w-[85%] mx-auto  items-center justify-center sm:gap-9">
     
      <img
        src="https://restan-nextjs.vercel.app/_next/image?url=%2Fassets%2Fimg%2Fthumb%2F14.jpg&w=1920&q=75"
        alt="Dining"
        className="h-[500px] sm:w-[50%] sm:h-[650px] object-cover "
      />
